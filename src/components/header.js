...
class Header extends Component {
    render() {
        return (
            <div>
                <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar" style={{ backgroundColor: 'blue' }}>
                        ...
                        <ul class="navbar-nav bd-navbar-nav flex-row">
                            ...
                            <li class="nav-item">
                                <Link className="nav-link " to="/details" >
                                    <span className={this.props.name === 'details' ? ` active` : null}>Details</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/final" >
                                    <span className={this.props.name === 'final' ? ` active` : null}>Final</span>
                                </Link>
                            </li>
                            {/* <li class="nav-item">
                                    <Link class="nav-link" to="/about"  target="_blank" rel="noopener">about</Link>
                                </li> */}
                            <li class="nav-item">
                                <Link className="nav-link " to="/data" >
                                 <span className={this.props.name === 'data' ? ` active` : null}>data</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                            <Link className="nav-link " to="/signup" >
                                 <span className={this.props.name === 'signup' ? ` active` : null}>signup</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/table" >
                                    <span className={this.props.name === 'table' ? ` active` : null}>Table</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/tabdata" >
                                    <span className={this.props.name === 'tablee' ? ` active` : null}>tablee</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/Userdetails" >
                                    <span className={this.props.name === 'userdetails' ? ` active` : null}>userdetails</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/Design" >
                                    <span className={this.props.name === 'design' ? ` active` : null}>design</span>
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link className="nav-link" to="/Navdesign" >
                                    <span className={this.props.name === 'navdesign' ? ` active` : null}>navdesign</span>
                                </Link>
                            </li>
                        </ul>
                    </div>
